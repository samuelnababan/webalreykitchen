...
$query = "SELECT cake_tbl.id, cake_tbl.cake_name, cake_tbl.cake_photo, cake_tbl.cake_price, category_tbl.category_name FROM cake_tbl INNER JOIN category_tbl ON cake_tbl.category_id = category_tbl.id WHERE category_tbl.id=$id";
