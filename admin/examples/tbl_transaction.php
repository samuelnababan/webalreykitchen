                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                if($status == 'SUCCES'|| $status == 'CHECKOUT' || $status == 'PENDING' || $status == 'PROSES' ){ ?>
                                                <td><a href="hapus_transaction.php?id=<?= $data['transaction_detail_id'];?>" onclick="return confirm('Anda yakin akan mengcancel data id= <?= $data['transaction_detail_id'];?>?')">Cancel</a></td>
                                                <?php } else { ?>
                                                    <td><button disabled href="hapus_transaction.php?id=<?= $data['transaction_detail_id'];?>" onclick="return confirm('Anda yakin akan mengcancel data id= <?= $data['transaction_detail_id'];?>?')">Cancel</button></td>
                                                <?php } ?>
                                                <td width="1%"></td>
                                            </tr>
                                            <?php } ?>
